...
Site published at: https://github.com/AgneIlg/Agne.git/48-grupe-todo/
...
1. Clone the repo
    ```sh
    git clone https://github.com/AgneIlg/Agne.git/48-grupe-todo.git
    ```
...
Rimantas: [Github](https://github.com/AgneIlg)
